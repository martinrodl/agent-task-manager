...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  const allowed = ['name', 'description', 'projectId', 'workspaceType', 'workspacePath', 'githubRepo', 'githubBranch', 'githubToken', 'webhookUrl', 'webhookSecret', 'sandboxMode', 'dockerImage', 'gitCloneUrl', 'setupScript'] as const
